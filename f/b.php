...
<!-- Header ชื่อของคุณ -->
<div class="container-fluid netflix-bar py-4 mb-4 text-center">
    <h1 class="netflix-title m-0">21Missionboss</h1>
</div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <?php while ($data = mysqli_fetch_array($rs)) { ?>
          ...
          <div class="card shadow-sm">
            ...
            <img src="<?php echo $data['image_url']; ?>" aria-label="Placeholder: Thumbnail" class="bd-placeholder-img card-img-top" height="420" preserveAspectRatio="xMidYMid slice" role="img" width="100%">
